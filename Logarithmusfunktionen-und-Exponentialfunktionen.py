...
def log(x, y):
    ...
    def diagramm():
        ...
        plt.title("log(T)(t) - Diagramm")
        plt.xlabel("Zeit t (in s)") 
        plt.ylabel("log( Temperatur T (in °C) )") 
        plt.show()
...
mode = input('Gibt "e" ein, um einen Fit für eine Exponentialfunktion durchzuführen. \nGib "log" ein, um Bacon auf log(Temperatur) anzuwenden. \n')
if (mode == 'log'): log(x, y)
if (mode == 'e'): e(x, y)
